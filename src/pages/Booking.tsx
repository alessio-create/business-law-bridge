...
const Booking = () => {
  ...
  const handleBooking = () => {
    // In production, this would integrate with Cal.com or similar
    setBooked(true);
  };
              ...
              <div className="w-full max-w-md grid grid-cols-2 gap-3 mt-4">
                {["Lun 10:00", "Mar 14:00", "Mer 11:00", "Gio 16:00", "Ven 09:00", "Ven 15:00"].map((slot) => (
                  <button
                    ...
                    className="flex items-center justify-center gap-2 p-4 rounded-xl border-2 border-border bg-background hover:border-primary hover:bg-primary/5 transition-all text-sm font-medium text-foreground"
                  >
