      ...
      <div ref={ref} className="max-w-[1060px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className={`bg-surface-container-low rounded-2xl p-7 md:p-8 shadow-ambient hover:shadow-ambient-md hover:-translate-y-0.5 transition-all duration-400 ease-out ${
            ...
            >
              ...
              <blockquote className="text-foreground text-[15px] font-medium leading-[1.7] mb-5">
                "{t.quote}"
              </blockquote>
              <div>
        ...
        {/* Social proof strip */}
        <div
          className={`mt-8 flex items-center justify-center gap-3 transition-all duration-700 ease-out delay-500 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
