import { PhoneCall, FileText, Shield, ArrowRight } from "lucide-react";
            ...
            >
              <div className="flex items-start gap-5">
                ...
                <div className="flex flex-col gap-2 pt-1">
                  <h3 className="text-foreground text-[15px] font-bold leading-snug">{s.title}</h3>
                  <p className="text-muted-foreground text-[13px] leading-[1.75]">{s.desc}</p>
                </div>
              </div>
            </div>
          ))}
